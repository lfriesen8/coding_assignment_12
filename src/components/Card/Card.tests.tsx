...
describe("Card Component", () => {
  ...
  test("renders card with image", () => {
    render(<Card title="Image Card" description="This card has an image." image="test.jpg" />);
    expect(screen.getByAltText("Image Card")).toBeInTheDocument();
  });

  test("calls button click handler", () => {
    const onClickMock = jest.fn();
    render(<Card title="Clickable Card" description="Click the button." buttonLabel="Click Me" onButtonClick={onClickMock} />);
