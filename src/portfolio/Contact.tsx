    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: '1 1 50%' }}>
          <h2 style={{ fontSize: '1.75rem', marginBottom: '1rem' }}>Contact Me</h2>
          ...
          <div style={{ marginTop: '1.5rem' }}>
            <Button label="Send Chat Request to Liam" onClick={handleSend} primary />
          </div>
        ...
        {/* RIGHT: Image */}
<div style={{ flex: '1 1 45%', textAlign: 'center', marginTop: '1rem' }}>
  <Img
    ...
    borderRadius="12px"
  />
  <p> I will get back to you as soon as I can! Thank you for stopping by, -Liam</p>
</div>
      </div>
    </section>
  );
